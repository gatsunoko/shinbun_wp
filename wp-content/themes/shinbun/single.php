...
if ( in_category(array('event')) ) {  // スラッグ（work）またはカテゴリーID（10）を指定します。
	get_template_part( 'event' , false ); // スラッグが「work」の時に、work.php を読み込みます。
} elseif ( in_category( array('magazine') )  )  { // スラッグ（info）またはカテゴリーID（9）を指定します。
	get_template_part( 'magazine' , false ); // スラッグが「info」の時に、info.php を読み込みます。
} elseif ( in_category( array('shop') )  )  { // スラッグ（info）またはカテゴリーID（9）を指定します。
	get_template_part( 'shop' , false ); // スラッグが「info」の時に、info.php を読み込みます。
} elseif ( in_category( array('shopping') )  )  { // スラッグ（info）またはカテゴリーID（9）を指定します。
	get_template_part( 'shopping' , false ); // スラッグが「info」の時に、info.php を読み込みます。
